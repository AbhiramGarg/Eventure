...
const eventsData = [
  ...
  { id: 3, name: 'Event 3', venue: 'Venue 3', time: 'Time 3', organizer: 'Organizer 3', description: 'Description 1', requirements: 'Pianist',applications: ['Artist 1', 'Artist 2'], image: require('../../../assets/images/event3.jpg') },
  { id: 4, name: 'Event 4', venue: 'Venue 4', time: 'Time 4', organizer: 'Organizer 4', description: 'Description 1', requirements: 'requirements', applications: ['Artist 1', 'Artist 2'], image: require('../../../assets/images/event1.jpg') },
];
...
export default function Feed() {
  ...
  const applyForEvent = (eventId, artistName) => {
    ...
    // Update eventsData or perform any necessary state management here
  };
