...
const eventsData = [
  ...
  { id: 3, name: 'Event 3', venue: 'Venue 3', time: 'Time 3', organizer: 'Organizer 3', description: 'Description 1', requirements: 'Pianist', image: require('../../../assets/images/event3.jpg') },
  { id: 4, name: 'Event 4', venue: 'Venue 4', time: 'Time 4', organizer: 'Organizer 4', description: 'Description 1', requirements: 'requirements', image: require('../../../assets/images/event1.jpg') },
  { id: 5, name: 'Event 5', venue: 'Venue 5', time: 'Time 5', organizer: 'Organizer 5', description: 'Description 1', requirements: 'requirements', image: require('../../../assets/images/event2.jpg') },
  { id: 6, name: 'Event 6', venue: 'Venue 6', time: 'Time 6', organizer: 'Organizer 6', description: 'Description 1', requirements: 'requirements', image: require('../../../assets/images/event3.jpg') },
  { id: 7, name: 'Event 7', venue: 'Venue 7', time: 'Time 7', organizer: 'Organizer 7', description: 'Description 1', requirements: 'requirements', image: require('../../../assets/images/event1.jpg') },
  { id: 8, name: 'Event 8', venue: 'Venue 8', time: 'Time 8', organizer: 'Organizer 8', description: 'Description 1', requirements: 'requirements', image: require('../../../assets/images/event2.jpg') },
];
            ...
            <View style={[styles.event, expandedEventId === event.id && styles.expandedEvent]}>
              ...
              {expandedEventId === event.id && (
                <View style={styles.expandedContent}>
                  ...
                  {!event.artist && userType !== 'org' &&  (
                  <TouchableOpacity style={styles.applyButton} onPress={() => alert('Apply clicked!')}>
...
const styles = StyleSheet.create({
  ...
  event: {
    ...
    borderRadius: 10,
    overflow: 'hidden',
    borderColor: 'white', // Cyan border color
